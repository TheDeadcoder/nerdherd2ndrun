<script>
	...
	let { session, supabase, classNow, teacherNow, students, ownerNow, accessPeople } = data;
	$: ({ session, supabase, classNow, teacherNow, students, ownerNow, accessPeople } = data);
