	...
	{:else}
		...
		<div class="min-h-screen text-center flex flex-col items-center">
			<div class="flex card shadow-2xl rounded-xl overflow-hidden max-w-4xl">
				...
				<div class="w-full p-8 flex flex-col items-center">
					<img
						src="https://dxpcgmtdvyvcxbaffqmt.supabase.co/storage/v1/object/public/demo/Untitled_design-removebg-preview.png"
						alt="Trainer"
						class="object-contain object-center mb-6"
					/>
					<div class="flex flex-col space-y-9">
						<div class="text-4xl text-center font-bold mb-6">As a Admin</div>
					</div>
					<div>
						<p class="text-xl text-center font-semibold">
							Analyze Permit Strategize
							<br />
							Permit Teacher Registrations
							<br />Fine tune models please dont ask how we noob
						</p>
					</div>
