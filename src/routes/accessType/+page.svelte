...
<section class="mt-28">
	...
	{:else}
		<div class=" mx-auto flex  justify-center items-center space-x-8 mb-1">
			<!-- {#if isLearner === 'ON'} -->
						...
						<div class="flex card shadow-2xl rounded-xl overflow-hidden max-w-4xl">
							...
							<div class="w-full p-8 flex flex-col items-center relative">
								...
								<div class="w-[100%] mt-5">
									<button
										type="submit"
										class=" btn font-bold text-xl p-4 bg-[#de7692] rounded-xl shadow-md hover:bg-[#b9396c] hover:text-[21px] hover:shadow-lg w-1/2"
