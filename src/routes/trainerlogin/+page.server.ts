...
export const actions = {
    default: async (event) => {
        ...
        if (user1?.istrainer === false) {
            return message(form, 'Invalid credentials. This mail is not registered as a trainer', {
                status: 400
            })
        }
        ...
        throw redirect(303, '/trainerverified/home/recent');
