...
<div class="pt-5 w-full mx-auto dark:bg-[#070707]">
    <div class="p-0 flex flex-col  w-full">
            ...
            <div class="cursor-pointer flex-grow px-5 py-5 text-center font-bold text-2xl hover:text-[27px] hover:bg-[#d8f0fd] border-r-4 text-[#57a8d6] border-[#57a8d6] dark:text-[#a7afb4] dark:border-[#a7afb4] dark:hover:bg-[#313b40] mt-40">
