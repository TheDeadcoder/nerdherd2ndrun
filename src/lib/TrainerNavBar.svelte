...
<div>
	<nav class="appbar">
		...
		<ul class="links">
			<li>
				<a href="routes/trainerverified/home/recent" class="flex items-center p-1 font-bold"
					><img
			...
			<li>
				<a href="routes/trainerverfied/library" class="flex items-center p-1 font-bold"
					><img
			...
			<li>
				<a href="routes/trainerverified/library" class="flex items-center p-1 font-bold"
					><img
			...
			<li>
				<a href="routes/library" class="flex items-center p-1 font-bold"
					><img
			...
			<li>
				<a href="routes/trainerverified/ai/gpt" class="flex items-center p-1 font-bold"
					><img
			...
			<li>
				<a href="routes/trainerverified/planner" class="flex items-center p-1 font-bold mr-3"
					><img
